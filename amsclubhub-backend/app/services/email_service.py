	...
	try:
		...
		<html>
			...
			<div style="max-width: 500px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 12px; padding: 24px;">
				...
				<p>Xin chào,</p>
				<p>Mã OTP để hoàn tất đăng ký tài khoản AmsClubHub của bạn là:</p>
				...
				<p style="font-size: 13px; color: #666;">Mã xác nhận có hiệu lực trong <strong>5 phút</strong>. Vui lòng không chia sẻ mã này cho bất kỳ ai.</p>
				<hr style="border: none; border-top: 1px solid #eee; margin-top: 25px;">
				<p style="font-size: 11px; color: #999; text-align: center;">AmsClubHub Team</p>
			</div>
			</body>
		</html>
		"""
...
async def send_reset_password_otp_email(to_email: str, otp_code: str) -> bool:
		...
		try:
				...
				<html>
					<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
						<div style="max-width: 500px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 12px; padding: 24px;">
							<h2 style="color: #111; text-align: center;">Đặt lại mật khẩu</h2>
							<p>Xin chào,</p>
							<p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản AmsClubHub gắn liền với email này.</p>
							...
							<p style="font-size: 13px; color: #666;">Mã này có hiệu lực trong <strong>5 phút</strong>. Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.</p>
							<hr style="border: none; border-top: 1px solid #eee; margin-top: 25px;">
							<p style="font-size: 11px; color: #999; text-align: center;">AmsClubHub Team</p>
						</div>
					</body>
