export default function PrivacyPage() {
	const sections = [
		...
		{
			id: 'sec-3',
			title: '3. Lưu trữ & Bảo mật hạ tầng',
			content: (
				<div className="space-y-2">
					...
					<ul className="list-disc pl-5 space-y-1">
						...
						<li>
							...
							chính sách phân quyền theo cấp tài khoản (Row Level Security - RLS).
						</li>
						<li>
		...
		{
			id: 'sec-4',
			title: '4. Quyền hạn người dùng',
			content: (
				<p>
					Bạn có quyền nhấn bỏ theo dõi (Unfollow) hoặc tắt tự động bật thông báo (Auto-Reminder) bất kỳ CLB nào để ngừng nhận thông báo, hoặc gửi yêu cầu cho Ban
		...
		{
			id: 'sec-5',
			title: '5. Lưu trữ cục bộ (Session)',
			content: (
				<p>
		...
		<div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
			...
			<div className="lg:col-span-8 space-y-10">
				<header className="border-b border-zinc-200 pb-6 space-y-2">
					<h1 className="text-3xl font-extrabold text-zinc-900">Quyền riêng tư</h1>
